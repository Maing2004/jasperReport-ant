...
public class jdlAddSanPham extends javax.swing.JDialog {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // Đảm bảo MainFrame.SoLuong luôn có giá trị hợp lệ
    int soLuong = (MainFrame.SoLuong != 0) ? MainFrame.SoLuong : 1;

    // Đảm bảo giá trị nằm trong phạm vi hợp lý
    if (soLuong < 1) {
        soLuong = 1;
    }

    txtMaSP.setText(MainFrame.MaSP);
    spnSoLuong.setModel(new javax.swing.SpinnerNumberModel(soLuong, 1, Integer.MAX_VALUE, 1));
